...
return function(StateMachine)
	...
	function State:Enter()
        ...
        UnloadThree:WaitForChild("DoorButton"):GetAttributeChangedSignal("Active"):Connect(function()
        ...
        UnloadTwo:WaitForChild("PressureButton"):GetAttributeChangedSignal("Active"):Connect(function()
		...
		local EntranceDoor = Level.LevelRelated:FindFirstChild("SlidingDoorSTART")
        ...
        local OutOfBoundDoor = Level.LevelRelated:FindFirstChild("OutofBoundSlidingDoor")
        ...
        OutOfBoundDoor:GetAttributeChangedSignal("Active"):Connect(function()
			if OutOfBoundDoor:GetAttribute("Active") and not OutofBoundSlidingDoorActive then
        ...
        TextureDoor:GetAttributeChangedSignal("Active"):Connect(function()
			if TextureDoor:GetAttribute("Active") and not TextureDoorActive then
        ...
        StartButton:GetAttributeChangedSignal("Active"):Connect(function()
			if StartButton:GetAttribute("Active") and not StartButtonActivated then
