...
function CameraObject:Construct() end
...
function CameraObject:Start()
	...
	repeat
		...
		task.wait(1)
	until CameraBlink
	local tweenSide1 = TweenService:Create(CameraBlink, tweenInfo, {
	...
	self.connection = RunService.RenderStepped:Connect(function()
		...
		if not CameraHead or not CameraMain then
			return
		end
